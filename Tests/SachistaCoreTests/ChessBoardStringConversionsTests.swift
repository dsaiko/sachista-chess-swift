...
class ChessBoardStringConversionsTests: XCTestCase {
    ...
    func testFenString() {
        ...
        XCTAssertFalse(board.castlingOptions.white.kingside)
        XCTAssertFalse(board.castlingOptions.white.queenside)
        XCTAssertFalse(board.castlingOptions.black.kingside)
        XCTAssertFalse(board.castlingOptions.black.queenside)
        ...
        XCTAssertTrue(board.castlingOptions.white.kingside)
        XCTAssertTrue(board.castlingOptions.white.queenside)
        XCTAssertFalse(board.castlingOptions.black.kingside)
        XCTAssertTrue(board.castlingOptions.black.queenside)
