...
public class MoveGeneratorBishop: MoveGenerator {
    ...
    func pieceMoves(sourceIndex: Int, allPieces: BitBoard) -> BitBoard {
        ...
        let stateIndexA8H1 = Int(((allPieces & a8H1Mask[sourceIndex]) &* a8H1Magic[sourceIndex]) >> 57)
        let stateIndexA1H8 = Int(((allPieces & a1H8Mask[sourceIndex]) &* a1H8Magic[sourceIndex]) >> 57)
        
        //add attacks
        return a8H1Moves[sourceIndex][stateIndexA8H1] | a1H8Moves[sourceIndex][stateIndexA1H8]
    }
